  ...
  Watcher.prototype.set = function (value) {
    ...
    if (forContext && forContext.alias === this.expression) {
      if (forContext.filters) {
        'development' !== 'production' && warn('It seems you are using two-way binding on ' + 'a krt-for alias (' + this.expression + '), and the ' + 'krt-for has filters. This will not work properly. ' + 'Either remove the filters or use an array of ' + 'objects and bind to object properties instead.', this.vm);
        return;
      }
...
var template = Object.freeze({
  ...
  var vFor = {
    ...
    bind: function bind() {
      ...
      if (!this.alias) {
        'development' !== 'production' && warn('Invalid krt-for expression "' + this.descriptor.raw + '": ' + 'alias is required.', this.vm);
        return;
      }
  ...
  var vIf = {
    ...
    bind: function bind() {
      ...
      if (!el.__vue__) {
        ...
        'development' !== 'production' && warn('krt-if="' + this.expression + '" cannot be ' + 'used on an instance root element.', this.vm);
        this.invalid = true;
      }
    },
  ...
  var model = {
    ...
    bind: function bind() {
      ...
      if (this.hasRead && !this.hasWrite) {
        'development' !== 'production' && warn('It seems you are using a read-only filter with ' + 'krt-model="' + this.descriptor.raw + '". ' + 'You might want to use a two-way filter to ensure correct behavior.', this.vm);
      }
      var el = this.el;
      var tag = el.tagName;
      var handler;
      if (tag === 'INPUT') {
        ...
        'development' !== 'production' && warn('krt-model does not support element type: ' + tag, this.vm);
        return;
      }
      el.__v_model = this;
  ...
  var on$1 = {
    ...
    update: function update(handler) {
      ...
      if (typeof handler !== 'function') {
        'development' !== 'production' && warn('krt-on:' + this.arg + '="' + this.expression + '" expects a function value, ' + 'got ' + handler, this.vm);
        return;
      }
  ...
  var ref = {
    bind: function bind() {
      'development' !== 'production' && warn('krt-ref:' + this.arg + ' must be used on a child ' + 'component. Found on <' + this.el.tagName.toLowerCase() + '>.', this.vm);
    }
  };
